...
É uma imagem que já foi pré-configurada com as camadas necessárias para a criação de um determinado tipo de container. Cada imagem gerada tem um propósito no container.
