...
**ADD** https://drive.google.com/file/d/1bs5v7oTTUIXbNwv6RRGYJdDAGd4VDg8E/view?usp=sharingdocker-file
...
ADD https://github.com/prometheus/node_exporter/releases/download/v1.11.1/node_exporter-1.11.1.linux-amd64.tar.gz --unpack /root/node-exporter/
LABEL "creator=carandre"
...
ENV APP_VERSION=2.2
HEALTHCHECK --interval=2s --start-period=5s CMD curl -f localhost
```
