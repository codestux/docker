...
Ele pode ser executado em outras plataformas, mas sem a performance que atinge em máquinas Linux. Está totalmente integrado com o Linux e usa diversos recursos e funções existentes no Kernel do OS Linux.
